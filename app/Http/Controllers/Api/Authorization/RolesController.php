...
use Vanguard\Http\Requests\Role\CreateCategoryRequest;
use Vanguard\Http\Requests\Role\RemoveRoleRequest;
use Vanguard\Http\Requests\Role\UpdateCategoryRequest;
...
class RolesController extends ApiController
{
     ...
     * @return RoleResource
     */
    public function update(Role $role, UpdateCategoryRequest $request)
    {
